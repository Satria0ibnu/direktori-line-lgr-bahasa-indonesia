...
$pack = query("SELECT * FROM cards WHERE nick_name = 'evowinter' ")[0];
    ...
    <main>
        ...
        <div class="content">
            ...
            <div class="content-item" id="skill-list" >
                <ul>
                    <li>1 : Saat aku tiba atau bangun landmarkku, 45% pindah ke tempat semula (+10% saat
...
berada di landmarkku selama turnku berakhir, 60% pasang [Ice Thorns] di landmark milikku</li>
                    <li>2: Saat game dimulai, 100% pilih dan raih Skill Winter's Super Defense (defense kurung
penjara / defense efek berbahaya / defense Completion) / Setiap chance daduku, 40%
Charge [Super Shield] (Maks. 2 level) &lt;Activation Exception&gt; / Saat lewati lawan setelah
lempar dadu, 70% ubah 1 lawan menjadi [Snowman]</li>
                </ul>
